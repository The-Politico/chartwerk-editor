  ...
  render: function() {
    return (
      <ul className="nav nav-tabs" role="tablist">
          ...
          <li role="presentation"><a href="#annotations" data-target="#annotations" aria-controls="annotations" role="tab" data-toggle="tab">Annotations</a></li>
          <li role="presentation"><a href="#code" data-target="#code" aria-controls="code" role="tab" data-toggle="tab">Code</a></li>
